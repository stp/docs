...
these tools are not a proper replacement for unit or integration testing, they provide a healty sanity check against
some forms of bugs. In particular, fuzzing does not test against performance regressions where certain optimisations
