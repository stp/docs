...
The version of STP submitted to STMCOMP 2015 is revision bff0edecbb7c08a of STP's publicly available source code
repository~\cite{STP:github} with CryptoMiniSat4 revision 24db9219b180 set as default solver. CryptoMiniSat4 is
available from its own public repository~\cite{CMS:github}.
